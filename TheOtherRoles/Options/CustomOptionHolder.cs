...
public class CustomOptionHolder
{
    ...
    public static string[] presets =
        ["‘§…Ë 1", "‘§…Ë 2", "‘§…Ë 3", "Skeld‘§…Ë", "Mira‘§…Ë", "Polus‘§…Ë", "Airship‘§…Ë", "Fungle‘§…Ë", "Submerged‘§…Ë"];
    ...
    */
    ...
    public static void Load()
    {
        ...
        var SortedOptionInfos = CustomRoleManager.AllRolesInfo.OrderBy(x => (int)x.Key);
        ...
        //executionerOnTargetDead = Create(20193, Types.Neutral, "Èê©ÓÜΩÁà£ÂßùËÆ≥È™∏ÈçöÂ∫°ÂΩâÊ∂ì?, [cs(Pursuer.color, "Pursuer"), cs(Jester.color, "Jester"), cs(Amnisiac.color, "Amnisiac"), "Crewmate"], executionerSpawnRate);
        ...
        /*balancerSpawnRate = Create(30330, Types.Crewmate, cs(GetRoleColor(RoleId.Balancer), "Balancer"), rates, null, true);
        ...
        //modifierDisperserRemainingDisperses = CustomOption.Create(40102, Types.Modifier, "ÈçíÂóòÊöéÂ®Ü‚ÑÉÊöü", 1f,1f,5f,1f, modifierDisperser);
    ...
    public static void SetupRoleOptions(RoleInfos info) => SetupRoleOptions(info.ConfigId, info.OptionType, info.RoleId, info.Color, info.NameKey, info.CanAssign, info.PlayerCount);

    public static void SetupRoleOptions(int id, Types tab, RoleId role, Color color, string Name, bool CanAssign, int PlayerCount, CustomGamemodes customGameMode = CustomGamemodes.Classic)
    {
        if (!CanAssign) return;

        var RoleOption = Create(id, tab, cs(color, Name), rates, null, true);
        var PlayerCountOption = Create(id + 1, tab, "RolesCount", 1, 1, PlayerCount, 1, RoleOption);

        CustomRoleSpawnChances.Add(role, RoleOption);
        CustomRoleCounts.Add(role, PlayerCountOption);
    }
}
