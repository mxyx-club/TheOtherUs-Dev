...
public class RoleInfo(string name, Color color, RoleId roleId, RoleType roleTeam, bool isGuessable = false)
{
    ...
    public RoleType RoleType = roleTeam;
    ...
    public static RoleInfo balancer = new("Balancer", GetRoleColor(RoleId.Balancer), RoleId.Balancer, RoleType.Crewmate);
    ...
    public static List<RoleInfo> getRoleInfoForPlayer(PlayerControl p, bool showModifier = true)
    {
        ...
        if (p.IsRole(RoleId.Balancer)) infos.Add(balancer);
                    ...
                    if (deadPlayer != null)
                    {
                        switch (deadPlayer.DeathReason)
                        {
                            case CustomDeathReason.Disconnect:
                                ...
                                break;
                            case CustomDeathReason.CmdKill:
