...
public class TheOtherRolesPlugin : BasePlugin
{
    ...
    public const string WebApi = "http://localhost:3000/";
#if RELEASE
    ...
    public static IEnumerable<PlayerControl> AllAlivePlayerControls => PlayerControl.AllPlayerControls.ToArray().Where(p => p != null && p.IsAlive() && !p.Data.Disconnected);
    ...
    public override void Load()
    {
        ...
        _ = CheckVersion.checkBeta(); // Exit if running an expired beta
